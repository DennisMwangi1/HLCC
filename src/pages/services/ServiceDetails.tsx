  ...
  return (
    ...
    >
      ...
      >
        ...
        <ChevronDown
          className={`w-5 h-5 text-[var(--gold-accent)] flex-shrink-0 transition-transform duration-300 ${
            isOpen ? "rotate-180" : ""
          }`}
        />
      </button>
...
export default function ServiceDetails() {
  ...
  return (
    <main>
      ...
      {/* ============================================================================ */}
      {/* TESTIMONIAL - Social proof with elegant quote design */}
      {/* ============================================================================ */}
      <section className="relative py-20 bg-gradient-to-br from-slate-100 via-slate-50 to-white overflow-hidden">
        {/* Decorative gradient orbs */}
        <div className="absolute top-20 left-10 w-64 h-64 bg-[var(--blue-accent)]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-10 right-20 w-80 h-80 bg-[var(--gold-accent)]/5 rounded-full blur-3xl" />
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-[var(--navy-dark)] to-[var(--navy-medium)] text-white shadow-2xl">
              {/* Decorative elements */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--gold-accent)]/10 rounded-full blur-3xl" />
              ...
              <CardContent className="relative p-8 md:p-12">
                ...
                <div className="mb-6">
                  <div className="w-14 h-14 rounded-2xl bg-white/10 backdrop-blur-sm flex items-center justify-center">
                    <Quote className="w-7 h-7 text-[var(--gold-accent)]" />
                  </div>
                </div>

                {/* Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-6">
                  <Award className="w-4 h-4 text-[var(--gold-accent)]" />
                  <span className="text-sm font-medium">Success Story</span>
                </div>

                {/* Title */}
                <h3 className="text-2xl md:text-3xl font-bold mb-6">
                  Transforming Leadership at {service.title.includes('Leadership') ? 'a Leading Tech Firm' : 'Enterprise Level'}
                </h3>

                {/* Quote */}
                <p className="text-lg text-white/90 leading-relaxed mb-8">
                  "Working with HLCC transformed our approach to {service.title.toLowerCase()}. 
                  Their expertise and hands-on support helped us achieve a 40% improvement in key performance metrics."
                </p>
